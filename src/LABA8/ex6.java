...
public class ex6 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            in = new FileReader("C:\\Users\\ES\\Desktop\\LB8\\Exam\\ex6\\MyFile1.txt"); // файл для чтения
            out = new FileWriter("C:\\Users\\ES\\Desktop\\LB8\\Exam\\ex6\\MyFile2.txt", true); // файл для записи
            // разрешено
            // добавление
